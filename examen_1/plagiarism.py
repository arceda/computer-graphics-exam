...
def compare_file_list(file_list, remove_pattern, template, tempalte_cui=''):

    if (len(file_list) > 1):
        cui_compare = file_list[0].split('/')[-2]
...
if __name__=="__main__":
    ...
    file_list = glob.glob(files_path + '*.py')
